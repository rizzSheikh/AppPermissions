...
public class AppPermissionsActivity extends Activity {
    ...
    static AppPermissionHandler permissionHandler;
        ...
        if (grantResults.length == 0) {
            ...
            if (deniedPermissions.size() == 0) {
                ...
                if (justBlockedList.size() > 0) { //checked don't ask again for at least one.
                    AppPermissionHandler permissionHandler = AppPermissionsActivity.permissionHandler;
                    finish();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == RC_SETTINGS && permissionHandler != null) {
            AppPermissions.check(this, toArray(allPermissions), null, options,
                    permissionHandler);
        }
